    ...
    <div className="min-h-screen bg-[#FAFAFA] flex">
      ...
      <div className="hidden lg:block lg:w-[45%] bg-navy relative overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col justify-center items-center px-16">
          <img src="/logo-icon.png" alt="BillSure" className="w-28 h-28 mb-8 drop-shadow-2xl" />
          <h2 className="text-3xl font-bold text-white mb-3 text-center" style={{ fontFamily: 'Outfit, sans-serif' }}>
            Never be surprised<br />by a bill again
          </h2>
          <p className="text-slate-400 text-sm leading-relaxed text-center max-w-xs">
