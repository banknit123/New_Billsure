  ...
  return (
    <div className="space-y-6" data-testid="settings-page">
      <div>
        ...
        <p className="text-gray-600 mt-1">Manage your account preferences and automation</p>
      </div>
      ...
      <Tabs defaultValue="account" className="w-full">
        ...
        {/* Direct Debit Tab */}
        <TabsContent value="direct-debit" className="mt-6">
          <DirectDebitManagement user={user} refreshUser={refreshUser} />
        </TabsContent>

        {/* Providers Tab */}
        <TabsContent value="providers" className="mt-6">
          <ProviderConnectionManager user={user} refreshUser={refreshUser} />
        </TabsContent>
